...
export const bonusMultiLineCenters: WorkCenterDoc[] = [
    {
        docId: 'wc-cnc',
        docType: 'workCenter',
        data: {
...
export const bonusMultiLineOrders: ManufacturingOrderDoc[] = [
    {
        docId: 'mo-multi',
...
export const bonusMultiLineWorkOrders: WorkOrderDoc[] = [
    {
        docId: 'wo-cnc-1',
        docType: 'workOrder',
        data: {
