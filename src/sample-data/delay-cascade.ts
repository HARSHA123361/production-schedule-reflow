...
export const delayCascadeWorkCenters: WorkCenterDoc[] = [
  {
    docId: 'wc-line-1',
    docType: 'workCenter',
    data: {
...
export const delayCascadeManufacturingOrders: ManufacturingOrderDoc[] = [
  {
    docId: 'mo-1',
...
export const delayCascadeWorkOrders: WorkOrderDoc[] = [
  {
    docId: 'wo-A',
    docType: 'workOrder',
    data: {
